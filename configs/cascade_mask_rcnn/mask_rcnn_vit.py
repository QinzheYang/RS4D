...
work_dir = '/mnt/dataset/yangqinzhe/panda-pth/cascade_mask_rcnn_whu'
...
model = dict(
    ...
    backbone=dict(
        ...
        norm_eval=True,
        style='pytorch',
        init_cfg=dict(type='Pretrained', checkpoint='/mnt/user/yangqinzhe/project/project_code/mm_panda_CoDETR/resnet50-0676ba61.pth')),
    neck=dict(
        type='FPN',
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        indices=None,
        data_root=data_root,
        ann_file='/mnt/dataset/yangqinzhe/Rsprompter-mamba/WHU/annotations/WHU_building_train.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        indices=None,
        data_root=data_root,
        ann_file='/mnt/dataset/yangqinzhe/Rsprompter-mamba/WHU/annotations/WHU_building_test.json',
