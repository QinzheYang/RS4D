...
work_dir = '/mnt/dataset/yangqinzhe/grss-pth/rotated_rtmdet_vith'
...
load_from = None
resume = False
hf_sam_pretrain_name = "work_dirs/sam_cache/sam_vit_large"
hf_sam_pretrain_ckpt_path = "work_dirs/sam_cache/sam_vit_large/pytorch_model.bin"
custom_hooks = [
