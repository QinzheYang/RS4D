...
work_dir = '/mnt/dataset/wanglubo/rs4d-pth/new/work_dirs/rs4d/rs4d-bbox-nwpu-noise-lr-4-bs4-1600epoch-10rs-2way-skip12-2025new-frozen'
...
model = dict(
    ...
    neck=dict(
        ...
        feature_aggregator=dict(
            ...
            out_channels=256,
            hidden_channels=32,
            select_layers=range(1,24,2)#range(1, 24, 2),range(3,24,7)
        ),
