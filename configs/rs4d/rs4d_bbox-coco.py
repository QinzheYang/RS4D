...
work_dir = '/mnt/dataset/yangqinzhe/rs4d-pth/new/work_dirs/rsprompter-test/rs4d-bbox-ssdd-coco'
...
data_root = '/mnt/dataset/wanglubo/coco'
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root='/mnt/dataset/wanglubo/coco/train2017',
        ann_file='/mnt/dataset/wanglubo/coco/annotations_trainval2017/annotations/instances_train2017.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root='/mnt/dataset/wanglubo/coco/val2017',
        ann_file='/mnt/dataset/wanglubo/coco/annotations_trainval2017/annotations/instances_val2017.json',
