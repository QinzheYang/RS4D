work_dir = '/mnt/dataset/yangqinzhe/rs4d-pth/new/work_dirs/rs4d/rs4d-bbox-nwpu-mask2former'
default_scope = 'mmdet'
custom_imports = dict(imports=['mmdet.rs4d'], allow_failed_imports=False)
...
detector_model = dict(
    ...
    backbone=dict(
        ...
        norm_eval=True,
        style='pytorch',
        init_cfg=dict(type='Pretrained', checkpoint='work_dirs/resnet/resnet50.pth')
    ),
    neck=dict(
        type='FPN',
...
code_root = '/mnt/home/xx/codes/rs4d'
