...
work_dir = '/mnt/dataset/yangqinzhe/rs4d-pth/prompt-whu'
...
vis_backends = [dict(type='LocalVisBackend'),
                #dict(type='WandbVisBackend', init_kwargs=dict(project='rsprompter-test', group='rsprompter-anchor', name=work_dir.split('/')[-1]))
                ]
visualizer = dict(
...
code_root = '/mnt/jfs/code/qinzheyang/rs4d'
data_root = '/mnt/dataset/yangqinzhe/rs4d/WHU/imgs/test'
