...
work_dir = '/mnt/dataset/wanglubo/rs4d-pth/new/work_dirs/rs4d/rs4d-bbox-mamba-whu-noise-bs4percard4-skip2-30-30-frozen'
...
vis_backends = [dict(type='LocalVisBackend'),
                #dict(type='WandbVisBackend', init_kwargs=dict(project='rs4d', group='rs4d', name='rs4d-whu'))
                ]
visualizer = dict(
...
data_root = '/mnt/dataset/yangqinzhe/rs4d/WHU'
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='/mnt/dataset/yangqinzhe/rs4d/WHU/annotations/WHU_building_train.json' ,
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='/mnt/dataset/yangqinzhe/rs4d/WHU/annotations/WHU_building_test.json',
...
base_lr = 0.000092224#9.2224e-05#0.0001
max_epochs = 800
