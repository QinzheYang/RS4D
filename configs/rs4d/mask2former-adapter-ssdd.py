...
pretrained = '/mnt/user/yangqinzhe/project/project_code/mm_panda_CoDETR/swin_large_patch4_window12_384_22k.pth'  # noqa
indices = None
load_from = None
log_level = 'INFO'
...
work_dir = '/mnt/dataset/yangqinzhe/panda-pth/maskformer-adapter'
