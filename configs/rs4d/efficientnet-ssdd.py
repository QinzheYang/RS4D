...
work_dir = '/mnt/dataset/yangqinzhe/Rsprompter-mamba-pth/new/work_dirs/rsprompter-test/efficient-ssdd'
...
checkpoint = '/mnt/user/yangqinzhe/project/project_code/RSPrompter-mamba/new.pth'  # noqa
model = dict(
    type='MaskRCNN',
    data_preprocessor=dict(
        type='DetDataPreprocessor',
