...
model = dict(
    ...
    neck=dict(
        feature_aggregator=dict(
            ...
            out_channels=256,
            select_layers=range(3, 24, 7),
            type='RSFeaturePaAggregator'),
...
work_dir = '/mnt/dataset/yangqinzhe/rs4d-pth/new/work_dirs/rs4d/rs4d-bbox-nwpu-noise-lr-4-bs6-1600epoch-skip6-2025new-19103-pa10'
