...
#data_root = '/root/autodl-tmp/project/project_code/workspace_pytorch/RSPrompter-mamba/data/WHU'
code_root = '/root/autodl-tmp/project/project_code/workspace_pytorch/RSPrompter-mamba'
data_root = '/mnt/dataset/yangqinzhe/Rsprompter-mamba/WHU'
crop_size = (
    1024,
    1024,
)
...
model = dict(
    ...
    neck=dict(
        feature_aggregator=dict(
            hidden_channels=32,
            in_channels='rsmamba_large',
            out_channels=256,
            select_layers=range(2, 28, 6),
...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/mnt/dataset/yangqinzhe/Rsprompter-mamba/WHU/annotations/WHU_building_test.json',
        data_prefix=dict(img='image'),
        data_root='/mnt/dataset/yangqinzhe/Rsprompter-mamba/WHU/imgs/test',
        indices=None,
        pipeline=[
...
train_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/mnt/dataset/yangqinzhe/Rsprompter-mamba/WHU/annotations/WHU_building_train.json',
        data_prefix=dict(img='image'),
        data_root='/mnt/dataset/yangqinzhe/Rsprompter-mamba/WHU/imgs/train',
        indices=None,
        pipeline=[
            dict(to_float32=True, type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True, with_mask=True),
...
work_dir = '/mnt/dataset/yangqinzhe/Rsprompter-mamba-pth/new/work_dirs/rsprompter-test/samseg-maskrcnn-mamba-whu-maskrcnn'
