...
work_dir = './work_dirs/rsprompter/rsprompter_anchor-nwpu_bs1_bf16'
...
code_root = '/data/yqz/project/project_code/workspace_pytorch/RSPrompter-mamba'
data_root = '/data/yqz/project/project_code/workspace_pytorch/RSPrompter-mamba/data/NWPU'
