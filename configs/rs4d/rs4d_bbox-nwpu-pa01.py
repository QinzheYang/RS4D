...
model = dict(
    ...
    neck=dict(
        feature_aggregator=dict(
            ...
            select_layers=range(3, 24, 7),#3，24，7
...
test_dataloader = dict(
    ...
    dataset=dict(
        ann_file=
        '/mnt/dataset/yangqinzhe/rs4d/NWPU/annotations/NWPU_instances_val.json',
...
train_cfg = dict(max_epochs=1600, type='EpochBasedTrainLoop', val_interval=2)
train_dataloader = dict(
    batch_size=6,
    dataset=dict(
        ann_file=
        '/mnt/dataset/yangqinzhe/rs4d/NWPU/annotations/NWPU_instances_train.json',
        data_prefix=dict(img='imgs'),
        data_root='/mnt/dataset/yangqinzhe/rs4d/NWPU',
        indices=None,
        pipeline=[
            ...
            dict(
                ...
                recompute_bbox=True,
                type='RandomCrop'),
            dict(type='Pad', size=crop_size, pad_val=dict(img=tuple(data_preprocessor['mean'][::-1]), mask=0)),
            dict(
                by_mask=True,
                min_gt_bbox_wh=(
                    1e-05,
...
work_dir = '/mnt/dataset/yangqinzhe/rs4d-pth/new/work_dirs/rs4d/rs4d-bbox-nwpu-500ks-noise-lr-4-bs6-1600epoch-skip4-2025new-19103-pa01-25w'
