...
def NMSop(bboxes: Tensor, scores: Tensor, iou_threshold: float, offset: int, score_threshold: float, max_num: int) -> Tensor:
	...
	'''
	inds = torchvision_nms(bboxes, scores, iou_threshold=float(iou_threshold))
...
def nms(boxes: array_like_type,
    ...
    inds = NMSop(boxes, scores, iou_threshold, offset, score_threshold, max_num)
