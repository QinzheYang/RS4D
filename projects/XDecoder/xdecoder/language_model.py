...
class LanguageEncoder(nn.Module):
    ...
    def __init__(
        self,
        tokenizer='openai/clip-vit-base-patch32',#'/mnt/user/yangqinzhe/project/project_code/RSPrompter-mamba/projects/XDecoder/pytorch_model.bin',#'openai/clip-vit-base-patch32',
        dim_lang=512,
        dim_projection=512,
    ):
        super().__init__()
