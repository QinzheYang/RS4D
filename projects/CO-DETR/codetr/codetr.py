...
class CoDETR(BaseDetector):
    ...
    def with_mask(self):
        ...
        return (hasattr(self, 'roi_head') and self.roi_head is not None and len(self.roi_head) > 0 and self.roi_head[
            0].with_mask)
    ...
    def predict(self,
        ...
        return batch_data_samples#https://github.com/Sense-X/Co-DETR/blob/main/projects/models/co_detr.py
    ...
    def predict_mask_head(self,
                           mlvl_feats: Tuple[Tensor],
                           batch_data_samples: SampleList,
                           rescale: bool = True) -> InstanceList:
        return self.mask_head.predict(
            mlvl_feats, batch_data_samples=batch_data_samples, rescale=rescale)
