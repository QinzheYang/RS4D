...
from mmpretrain.models.utils import build_clip_model
from mmpretrain.models.selfsup.base import BaseSelfSupervisor
from .mae import MAEViT1


@MODELS.register_module()
class CLIPGenerator1(nn.Module):
...
class MILANViT1(MAEViT1):
    ...
    def forward(
        ...
        if importance is None:
            return super(MAEViT1, self).forward(x)
...
@MODELS.register_module()
class MILAN1(BaseSelfSupervisor):
    """MILAN.
